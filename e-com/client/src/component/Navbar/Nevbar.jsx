			...
			<div className="top-menu border-bottom">
				<div className="container">
					<nav className="navbar navbar-expand">
						<div className="shiping-title text-uppercase font-13 d-none d-sm-flex">Welcome to our eTrans store!</div>
						<ul className="navbar-nav ms-auto d-none d-lg-flex">
							<li className="nav-item"> <Link className="nav-link" to="order-tracking.html">Track Order</Link>
							</li>
							<li className="nav-item"> <Link className="nav-link" to="about-us.html">About</Link>
							</li>
							<li className="nav-item"> <Link className="nav-link" to="shop-categories.html">Our Stores</Link>
							</li>
							<li className="nav-item"> <Link className="nav-link" to="blog.html">Blog</Link>
							</li>
							<li className="nav-item">	<Link className="nav-link" to="contact-us.html">Contact</Link>
							</li>
							<li className="nav-item">	<Link className="nav-link" to="javascript:;">Help & FAQs</Link>
							</li>
						</ul>
						<ul className="navbar-nav">
							<li className="nav-item dropdown"> <Link className="nav-link dropdown-toggle" to="#" data-bs-toggle="dropdown">USD</Link>
							...
							<li className="nav-item dropdown">
								...
								<div className="dropdown-menu dropdown-menu-lg-end">
									<Link className="dropdown-item d-flex allign-items-center" to="javascript:;"> <i className="flag-icon flag-icon-de me-2"></i><span>German</span>
									</Link>	<Link className="dropdown-item d-flex allign-items-center" to="javascript:;"><i
								className="flag-icon flag-icon-fr me-2"></i><span>French</span></Link>
									<Link className="dropdown-item d-flex allign-items-center" to="javascript:;"><i
						...
						<ul className="navbar-nav social-link ms-lg-2 ms-auto">
							<li className="nav-item"> <Link className="nav-link" to="javascript:;"><i className='bx bxl-facebook'></i></Link>
							</li>
							<li className="nav-item"> <Link className="nav-link" to="javascript:;"><i className='bx bxl-twitter'></i></Link>
							</li>
							<li className="nav-item"> <Link className="nav-link" to="javascript:;"><i className='bx bxl-linkedin'></i></Link>
							</li>
						</ul>
					</nav>
				</div>
							...
							<div className="top-cart-icons float-end">
								<nav className="navbar navbar-expand">
									<ul className="navbar-nav ms-auto">
										<li className="nav-item"><Link to="account-dashboard.html" className="nav-link cart-link"><i className='bx bx-user'></i></Link>
										</li>
										<li className="nav-item"><Link to="wishlist.html" className="nav-link cart-link"><i className='bx bx-heart'></i></Link>
										</li>
				...
				<div className="container">
					<nav id="navbar_main" className="mobile-offcanvas navbar navbar-expand-lg">
						...
						<ul className="navbar-nav">
							...
							<li className="nav-item dropdown">	<Link className="nav-link dropdown-toggle dropdown-toggle-nocaret" to="#" data-bs-toggle="dropdown">Categories <i className='bx bx-chevron-down'></i></Link>
								<div className="dropdown-menu dropdown-large-menu">
									<div className="row">
										<div className="col-md-4">
											<h6 className="large-menu-title">Fashion</h6>
											<ul className="">
												<li><Link to="#">Casual T-Shirts</Link>
												</li>
												<li><Link to="#">Formal Shirts</Link>
												</li>
												<li><Link to="#">Jackets</Link>
												</li>
												<li><Link to="#">Jeans</Link>
												</li>
												<li><Link to="#">Dresses</Link>
												</li>
												<li><Link to="#">Sneakers</Link>
												</li>
												<li><Link to="#">Belts</Link>
												</li>
												<li><Link to="#">Sports Shoes</Link>
												</li>
											</ul>
										</div>
										<div className="col-md-4">
											...
											<ul className="">
												<li><Link to="#">Mobiles</Link>
												</li>
												<li><Link to="#">Laptops</Link>
												</li>
												<li><Link to="#">Macbook</Link>
												</li>
												<li><Link to="#">Televisions</Link>
												</li>
												<li><Link to="#">Lighting</Link>
												</li>
												<li><Link to="#">Smart Watch</Link>
												</li>
												<li><Link to="#">Galaxy Phones</Link>
												</li>
												<li><Link to="#">PC Monitors</Link>
												</li>
											</ul>
										</div>
										<div className="col-md-4">
							...
							<li className="nav-item dropdown">	<Link className="nav-link dropdown-toggle dropdown-toggle-nocaret" to="#" data-bs-toggle="dropdown">My Account  <i className='bx bx-chevron-down'></i></Link>
								<ul className="dropdown-menu">
									<li><Link className="dropdown-item" to="account-dashboard.html">Dashboard</Link>
									</li>
									<li><Link className="dropdown-item" to="account-downloads.html">Downloads</Link>
									</li>
									<li><Link className="dropdown-item" to="account-orders.html">Orders</Link>
									</li>
									<li><Link className="dropdown-item" to="account-payment-methods.html">Payment Methods</Link>
									</li>
									<li><Link className="dropdown-item" to="account-user-details.html">User Details</Link>
									</li>
								</ul>
							</li>
							<li className="nav-item"> <Link className="nav-link" to="blog.html">Blog </Link> 
